...
gdjs.GameSceneCode.GDScoreMultiplierObjects5= [];
gdjs.GameSceneCode.GDMediumGreyMeteor1Objects1= [];
gdjs.GameSceneCode.GDMediumGreyMeteor1Objects2= [];
gdjs.GameSceneCode.GDMediumGreyMeteor1Objects3= [];
gdjs.GameSceneCode.GDMediumGreyMeteor1Objects4= [];
gdjs.GameSceneCode.GDMediumGreyMeteor1Objects5= [];
gdjs.GameSceneCode.GDShadedDarkJoystickObjects1= [];
gdjs.GameSceneCode.GDShadedDarkJoystickObjects2= [];
gdjs.GameSceneCode.GDShadedDarkJoystickObjects3= [];
gdjs.GameSceneCode.GDShadedDarkJoystickObjects4= [];
gdjs.GameSceneCode.GDShadedDarkJoystickObjects5= [];
...
}{runtimeScene.getScene().getVariables().get("Difficulty").mul(1.00);
}{gdjs.evtTools.runtimeScene.resetTimer(runtimeScene, "RockSpawn");
}
{ //Subevents
...
}{gdjs.evtTools.sound.playSound(runtimeScene, "man turns into dancing skeleton with music playing.mp3", true, 100, 1);
}}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(9531500);
}
}
if (isConditionTrue_0) {
...
gdjs.GameSceneCode.GDScoreMultiplierObjects5.length = 0;
gdjs.GameSceneCode.GDMediumGreyMeteor1Objects1.length = 0;
gdjs.GameSceneCode.GDMediumGreyMeteor1Objects2.length = 0;
gdjs.GameSceneCode.GDMediumGreyMeteor1Objects3.length = 0;
gdjs.GameSceneCode.GDMediumGreyMeteor1Objects4.length = 0;
gdjs.GameSceneCode.GDMediumGreyMeteor1Objects5.length = 0;
gdjs.GameSceneCode.GDShadedDarkJoystickObjects1.length = 0;
gdjs.GameSceneCode.GDShadedDarkJoystickObjects2.length = 0;
gdjs.GameSceneCode.GDShadedDarkJoystickObjects3.length = 0;
gdjs.GameSceneCode.GDShadedDarkJoystickObjects4.length = 0;
gdjs.GameSceneCode.GDShadedDarkJoystickObjects5.length = 0;
